...
var PayPalCardFieldsForm = function(_a) {
  var className = _a.className, options = __rest(_a, ["className"]);
  return import_react.default.createElement("div", {
    className
  }, import_react.default.createElement(PayPalCardField, __assign({
    fieldName: "NameField"
  }, options)), import_react.default.createElement(PayPalCardField, __assign({
    fieldName: "NumberField"
  }, options)), import_react.default.createElement(FlexContainer, null, import_react.default.createElement(FullWidthContainer, null, import_react.default.createElement(PayPalCardField, __assign({
    fieldName: "ExpiryField"
  }, options))), import_react.default.createElement(FullWidthContainer, null, import_react.default.createElement(PayPalCardField, __assign({
    fieldName: "CVVField"
  }, options)))));
};
var FUNDING$1 = {
